...
class UpdateProductCategory extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:update_product_category';
    ...
    public function handle()
    {
        ...
        //$page = 1;
		//$orders = $kiotVietApi->getProducts($lastModified, $page);
		//dd($orders);
        self::synProductCategory();
        echo "Done synProductCategory";
    }
	...
	public static function synProductCategory() {
        ...
        foreach ($posts as $item) {
            DB::table('product')->where('id', $item->product_id)->update(['category_ids' => $item->category_ids]);
        }
    }
