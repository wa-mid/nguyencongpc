    ...
    public function upload()
    {
        ...
        if (!is_array($files)) {
            ...
            if (!$this->fileIsValid($file)) {
                return $this->responseError($this->errors);
            }
        ...
        return count($this->errors) > 0 ? $this->responseError($this->errors) : parent::$success_response;
    }
    private function responseError($errors) {
        return ['error' => ['number' => 202, 'message' => $errors[0]]];
    }
