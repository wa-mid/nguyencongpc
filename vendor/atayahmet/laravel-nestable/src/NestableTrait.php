...
trait NestableTrait
{
     ...
     * @return string
     */
    public static function renderAsMultipleExt()
    {
        return self::multiple()->nested(static::$toDropdownExt)->get();
    }
    ...
    protected function deleteParameter($method) {
        static::$parameters[$method] = [];
        return $this;
    }
